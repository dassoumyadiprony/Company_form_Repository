...
namespace CVMSCore.BAL
{
    public static class ConnectionFile
    {
        ...
        public static string Connection_ANTSDB = "Data Source=192.168.1.164\\ATLCDBA;Initial Catalog=SAF;User ID =Satarupa1; Password=Arnab@123;Integrated Security=True;Trusted_Connection=False;";
        //// for server publish
